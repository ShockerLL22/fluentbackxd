...
local Themes = {
	...
	Midnight = {
	 Name = "Midnight",
	 Accent = Color3.fromRGB(88, 175, 255), -- brighter, neon blue accent
	 AcrylicMain = Color3.fromRGB(18, 18, 28), -- deeper dark background
	 AcrylicBorder = Color3.fromRGB(60, 60, 100), -- softer border
	 AcrylicGradient = ColorSequence.new(Color3.fromRGB(12, 12, 28), Color3.fromRGB(25, 25, 55)), -- smooth gradient
 	 AcrylicNoise = 0.92, -- subtle noise
	 TitleBarLine = Color3.fromRGB(70, 70, 120),
	 Tab = Color3.fromRGB(100, 110, 180), -- slightly more vibrant
	 Element = Color3.fromRGB(85, 80, 150),
	 ElementBorder = Color3.fromRGB(28, 28, 45),
	 InElementBorder = Color3.fromRGB(90, 85, 130),
	 ElementTransparency = 0.85,
	 ToggleSlider = Color3.fromRGB(95, 150, 220),
	 ToggleToggled = Color3.fromRGB(40, 15, 90),
	 SliderRail = Color3.fromRGB(95, 140, 210),
	 DropdownFrame = Color3.fromRGB(150, 150, 220),
	 DropdownHolder = Color3.fromRGB(28, 28, 60),
	 DropdownBorder = Color3.fromRGB(25, 25, 55),
	 DropdownOption = Color3.fromRGB(100, 110, 180),
	 Keybind = Color3.fromRGB(90, 130, 180),
	 Input = Color3.fromRGB(100, 100, 180),
	 InputFocused = Color3.fromRGB(25, 12, 40),
	 InputIndicator = Color3.fromRGB(150, 180, 255),
	 Dialog = Color3.fromRGB(30, 30, 70),
	 DialogHolder = Color3.fromRGB(20, 20, 50),
	 DialogHolderLine = Color3.fromRGB(22, 22, 55),
	 DialogButton = Color3.fromRGB(50, 48, 90),
	 DialogButtonBorder = Color3.fromRGB(80, 80, 130),
	 DialogBorder = Color3.fromRGB(70, 70, 110),
	 DialogInput = Color3.fromRGB(45, 45, 75),
	 DialogInputLine = Color3.fromRGB(160, 160, 255),
	 Text = Color3.fromRGB(245, 245, 245),
 	 SubText = Color3.fromRGB(180, 180, 200),
	 Hover = Color3.fromRGB(100, 120, 180),
	 HoverChange = 0.05,
},
